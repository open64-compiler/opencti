...
# ====================================================================
# 
# Filter to strip out line numbers and physical registers from asm output.
...
# To 
#
#  cp_and.s:NNN: warning 4164: possible WAW (implied) on resource(s) 'R00X'
#
#-----------
#
...
while ($line = <IN>) {
  ...
  $line =~ s/resource\(s\) \'r(\d+)\'/resource\(s\) \'rX\'/g;
  print $line;
}
exit 0;
