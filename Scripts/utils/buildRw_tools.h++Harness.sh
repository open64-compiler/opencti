...
ln -s $CTI_GROUPS/Lang/RogueWave/toolsh/rogue/Src/rwtest rwtest

cd lib
ln -s $CTI_GROUPS/Lang/RogueWave/toolsh/rogue/Src/rwtest rwtest
ln -s $CTI_GROUPS/Lang/RogueWave/toolsh/rogue/Src/rwtest/* .
BCMD="$CXX $CXX_OPTIONS $DATA_MODE_FLAG ${CTI_OPT_SIGN}O${OPT_LEVEL} rwtest.cpp cmdline.cpp script.cpp scriptst.cpp scptoken.cpp pcode.cpp testmgr.cpp -c  -Iinclude  -I.. -I../.. -I../../include -I."

$BCMD >librwtest.out  1> librwtest.err 2>&1

/usr/bin/ar rvu librwtest.a rwtest.o cmdline.o script.o scriptst.o scptoken.o pcode.o testmgr.o 1>> librwtest.err 2>&1
