...
ln -s $CTI_GROUPS/Lang/RogueWave/stdlib_new/stdlib.020201/test/rwtest rwtest
ln -s $CTI_GROUPS/Lang/RogueWave/stdlib_new/stdlib.020201/test/rw rw
ln -s $CTI_GROUPS/Lang/RogueWave/stdlib_new/stdlib.020201/test/stlfw stlfw

cd lib
ln -s $CTI_GROUPS/Lang/RogueWave/stdlib_new/stdlib.020201/test/rwtest rwtest
ln -s $CTI_GROUPS/Lang/RogueWave/stdlib_new/stdlib.020201/test/include include
ln -s $CTI_GROUPS/Lang/RogueWave/stdlib_new/stdlib.020201/test/rwtest/* .
BCMD="$CXX $CXX_OPTIONS $DATA_MODE_FLAG ${CTI_OPT_SIGN}O${OPT_LEVEL}  rwtest.cpp cmdline.cpp script.cpp pcode.cpp scptoken.cpp scriptst.cpp testmgr.cpp  singleton.cpp qestream.cpp lockfile.cpp -c  -Iinclude  -I.. -I../.. -I../../include -I."

$BCMD >librwtest.out  1> librwtest.err 2>&1

$CTI_AR rvu librwtest.a  rwtest.o cmdline.o script.o pcode.o scptoken.o scriptst.o testmgr.o  singleton.o qestream.o lockfile.o 1>> librwtest.err 2>&1
