...
# ====================================================================
# 
# This is the generic RTS test unit driver script. For more info,
# see $CTI_HOME/doc/proposals/script-based-testing.doc.
...
# set to the file .
# 
# Driver for script-based testing. 
#
...
umask 0002;
scriptDriver($this_unit,0,$me_fullpath);
exit 0;
