...
int test_omp_test_nest_lock(FILE * logFile)
{
...
int main()
{
	...
	static const char * logFileName = "ctest_omp_test_nest_lock.log";	/* name of the logfile */
	...
	printf("##############################################\n");
	printf("Testing omp_test_nest_lock\n\n");

	fprintf(logFile,"######## OpenMP Validation Suite V %s ######\n", OMPTS_VERSION );
	fprintf(logFile,"## Repetitions: %3d                       ####\n",REPETITIONS);
	fprintf(logFile,"## Loop Count : %6d                    ####\n",LOOPCOUNT);
	fprintf(logFile,"##############################################\n");
	fprintf(logFile,"Testing omp_test_nest_lock\n\n");

	for ( i = 0; i < REPETITIONS; i++ ) {
		fprintf (logFile, "\n\n%d. run of test_omp_test_nest_lock out of %d\n\n",i+1,REPETITIONS);
		if(test_omp_test_nest_lock(logFile)){
