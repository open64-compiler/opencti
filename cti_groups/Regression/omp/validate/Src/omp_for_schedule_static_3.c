...
int test_omp_for_schedule_static_3 (FILE * logFile)
{
  int threads;
  int i,lasttid;
...
int main()
{
	...
	static const char * logFileName = "ctest_omp_for_schedule_static_3.log";	/* name of the logfile */
	...
	for ( i = 0; i < REPETITIONS; i++ ) {
		fprintf (logFile, "\n\n%d. run of test_omp_for_schedule_static_3 out of %d\n\n",i+1,REPETITIONS);
		if(test_omp_for_schedule_static_3(logFile)){
