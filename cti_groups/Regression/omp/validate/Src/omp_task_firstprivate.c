...
int main()
{
	...
	static const char * logFileName = "ctest_omp_task_firstprivate.log";	/* name of the logfile */
	...
	fprintf(logFile,"##############################################\n");
	fprintf(logFile,"Testing omp task firstprivate\n\n");

	for ( i = 0; i < REPETITIONS; i++ ) {
		fprintf (logFile, "\n\n%d. run of test_omp_task_firstprivate out of %d\n\n",i+1,REPETITIONS);
		if(test_omp_task_firstprivate(logFile)){
