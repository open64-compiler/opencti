...
int main()
{
	...
	static const char * logFileName = "ctest_omp_parallel_sections_lastprivate.log";	/* name of the logfile */
	...
	fprintf(logFile,"##############################################\n");
	fprintf(logFile,"Testing omp parallel sections lastprivate\n\n");

	for ( i = 0; i < REPETITIONS; i++ ) {
		fprintf (logFile, "\n\n%d. run of test_omp_parallel_sections_lastprivate out of %d\n\n",i+1,REPETITIONS);
		if(test_omp_parallel_sections_lastprivate(logFile)){
