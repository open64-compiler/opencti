...
int main()
{
	...
	static const char * logFileName = "ctest_omp_for_schedule_dynamic.log";	/* name of the logfile */
	...
	fprintf(logFile,"##############################################\n");
	fprintf(logFile,"Testing omp for schedule(dynamic)\n\n");

	for ( i = 0; i < REPETITIONS; i++ ) {
		fprintf (logFile, "\n\n%d. run of test_omp_for_schedule_dynamic out of %d\n\n",i+1,REPETITIONS);
		if(test_omp_for_schedule_dynamic(logFile)){
